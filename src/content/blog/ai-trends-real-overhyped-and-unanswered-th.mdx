...
นี่ไม่ใช่แค่คำถามเรื่อง product แต่เป็นปัญหา billing infrastructure ฝั่ง backend ต้อง produce immutable, auditable logs ของ agent workflows ที่ทั้งสองฝ่ายเชื่อถือได้
