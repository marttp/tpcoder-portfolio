---
title: "20 คำถาม Backend ที่ผมอยากย้อนเวลาไปบอกตัวเอง (บันทึกเตรียมสัมภาษณ์)"
...
![การทำ Pagination แบบ Offset vs Keyset](/assets/images/blogs/20-backend-questions/offset-vs-keyset.png)
...
![ปัญหา N+1 Query และการแก้ไข](/assets/images/blogs/20-backend-questions/n-plus-one.png)
...
![การป้องกัน Double Booking ด้วย Database Locking](/assets/images/blogs/20-backend-questions/double-booking.png)
...
![อัลกอริทึม Redlock สำหรับ Distributed Lock](/assets/images/blogs/20-backend-questions/redlock.png)
...
![การทำ Idempotency สำหรับการ Retry ระบบชำระเงิน](/assets/images/blogs/20-backend-questions/idempotency.png)
...
![การเกิด Cache Stampede และแนวทางป้องกัน](/assets/images/blogs/20-backend-questions/cache-stampede.png)
...
![การประมวลผลงานแบบ Synchronous vs Asynchronous Worker](/assets/images/blogs/20-backend-questions/sync-vs-async.png)
...
![เปรียบเทียบสถาปัตยกรรม RabbitMQ vs Apache Kafka](/assets/images/blogs/20-backend-questions/rabbitmq-vs-kafka.png)
